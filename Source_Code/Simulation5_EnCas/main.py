"""
Periodic stratified box with sinusoidal forcing.
To run and plot using e.g. 4 (2x2) processes:
...
def initialize_forcing(domain, k_range = [7,8]):
...
try:
    ...
    while solver.proceed:
        ...
        phi = particle_tracker.calculate_order_parameter()
