...
restart = False # True to restart from previous simulation
...
if restart:
    checkpoint_file = 'checkpoints/checkpoints_s1.h5'  # Use the latest checkpoint
    solver.load_state(checkpoint_file)
...
timeseries.add_task(d3.Integrate(omega**2),  layout='g', name='<omega**2>')
...
# v0    = 0.1    # swim speed
# r_int = 0.01      # interaction radius
# rho_p = 1      # particle density
# a     = 0.171   # particle radius
# rho_f = 1000.0 # fluid density
# nu    = 1e-6   # kinematic viscosity
# noise = 0.01  # Noise
# particle_tracker = particles.particles(N,dist,(xbasis, ybasis),
#                 T, v0, r_int, rho_p, a, rho_f, nu,noise,
#                 scale=None, loc=None)
#
# locs = []
...
try:
    ...
    while solver.proceed:
        ...
        logger.info(
            ...
            f"<omega**2>={omega2:.4e}, <|d omega|**2>={domega2:.4e},f'<omega*f>={omegaf:.4e}"
